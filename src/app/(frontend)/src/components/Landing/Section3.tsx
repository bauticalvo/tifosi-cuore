...
export const Section3 = () => {
  return (
    <div className="h-auto w-full flex flex-col md:flex-row">
      <section className="flex items-center justify-center w-full md:w-1/2 h-[400px] md:h-[800px] border-y-1 border-r-1 border-light group relative ">
      ...
      <section className="flex items-center justify-center w-full md:w-1/2 h-[400px] md:h-[800px] border-y-1 border-l-1 border-light group relative ">
